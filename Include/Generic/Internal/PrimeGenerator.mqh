...
const static int CPrimeGenerator::s_primes[] = {
    ...
    131,       163,       197,       239,       293,        353,        431,        521,        631,       761,       919,       1103,
    1327,      1597,      1931,      2333,      2801,       3371,       4049,       4861,       5839,      7013,      8419,      10103,
    12143,     14591,     17519,     21023,     25229,      30293,      36353,      43627,      52361,     62851,     75431,     90523,
    108631,    130363,    156437,    187751,    225307,     270371,     324449,     389357,     467237,    560689,    672827,    807403,
    968897,    1162687,   1395263,   1674319,   2009191,    2411033,    2893249,    3471899,    4166287,   4999559,   5999471,   7199369,
    8332579,   9999161,   11998949,  14398753,  16665163,   19998337,   23997907,   28797523,   33330329,  39996683,  47995853,  57595063,
    66660701,  79993367,  95991737,  115190149, 133321403,  159986773,  191983481,  230380307,  266642809, 319973567, 383966977, 460760623,
    533285671, 639947149, 767933981, 921521257, 1066571383, 1279894313, 1535867969, 1843042529, 2133142771};
...
int CPrimeGenerator::GetPrime(const int min)
{
    ...
    for (int j = (min | 1); j <= INT_MAX; j += 2) {
        if (IsPrime(j) && ((j - 1) % s_hash_prime != 0)) return (j);
    }
    return (min);
}
//+------------------------------------------------------------------+
...
{
    if (old_size >= INT_MAX / 2) return (INT_MAX);
